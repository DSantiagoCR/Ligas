...
use common\models\search\DocumentosSearch;
...
class DocumentosController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new documentos",
                    'content'=>'<span class="text-success">Create documentos success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing documentos model.
     * For ajax request will return json object
    ...
    public function actionListDocumentos()
    {
        $request = Yii::$app->request;
        return $this->render('_lista_docu');
    }

     /**
     * Delete multiple existing documentos model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
