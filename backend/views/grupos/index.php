...
/* @var $searchModel common\models\search\GruposSearch */
            ...
            <div class="card-body">
                ...
                <div id="ajaxCrudDatatable">
                    <?= GridView::widget([
                        ...
                        'toolbar' => [
                            [
                                ...
                                Html::a(
                                    ...
                                    ['create'],
                                    ['role' => 'modal-remote', 'title' => 'Create new Grupos', 'class' => 'btn btn-default']
                                ) .
                                    Html::a(
                        ...
                        'panel' => [
                            'type' => 'primary',
                            'heading' => '<i class="glyphicon glyphicon-list"></i> Grupos ',
                            'before' => '',
