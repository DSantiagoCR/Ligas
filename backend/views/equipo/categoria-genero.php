...
<h3 style="color:red">Categoría y Género </h2>
        ...
        <div class="col-8">
            <table class="table table-bordered border-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        <td> <?= $modelEquipo->nombre ?></td>
                        <td> <?= ($modelEquipo->id_categoria)?$modelEquipo->categoria->valor:'' ?></td>
                        <td> <?= ($modelEquipo->id_genero)?$modelEquipo->genero->valor:'' ?></td>
                        <td>
                            <?php
                            if ($modelEquipo->activo )
                            { 
                            ?>
